                ...
                <div class="col-12 border border-4 border-warning rounded-4">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <p class="fs-1 text-bg-secondary rounded-5 fw-bold mt-2 pt-1 text-decoration-underline"><img style="width:60px;" src="img/wrench-solid-60.png" > Update Products...! </i></p>
                        </div>
                            ...
                            <div class="row border border-warning bg-white">
                                ...
                                <div class="col-12 col-lg-4 offset-0 offset-lg-2">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <label class="form-label fw-bold" style="font-size: 20px;">Update Product Category</label>
                                ...
                                <div class="col-12 col-lg-4 ">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold " style="font-size: 20px;">Update Product Brand</label>
                                        </div>

                                        <div class="col-12">
                                            <select class="form-select  bg-warning" id="brand">
                                                <option value="0">Update Brand</option>
                            ...
                            <div class="row border border-warning bg-white">
                                ...
                                <div class="col-12 col-lg-4 offset-0 offset-lg-2">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold" style="font-size: 20px;">Update Product Model</label>
                                        </div>

                                        <div class="col-12">
                                            <select class="form-select text-center bg-warning" id="model">
                                                <option>Update Model</option>
                                                <option>apple Wotch</option>
                                                <option>drone cam</option>
                                ...
                                <div class="col-12 col-lg-4 ">
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label fw-bold " style="font-size: 20px;">Update Product Colour</label>
                                        </div>
                                        <div class="col-12">
                                            

                                            <select class="form-select bg-warning" id="clr">
                                                <option>Update Colour</option>
                                                <option>Blue</option>
                                                <option>Red</option>
                                                <option>white</option>
                                                <option>Black</option>                                                   
                        ...
                        <div class="col-12 col-lg-6 mt-2">
                                ...
                                <div class="row border border-warning bg-white">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="form-label fw-bold" style="font-size: 20px;">Update Condition</label>
                                            </div>
                                            <div class="col-12 ">
                                ...
                                <div class="row border border-warning bg-white mt-2">
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label fw-bold" style="font-size: 20px;">Update Item Cost</label>
                                        </div>
                                ...
                                <div class="row border border-warning bg-white mt-2">
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label fw-bold" style="font-size: 20px;">Update Item Discount</label>
                                        </div>
                                        <div class="offset-0 offset-lg-2 col-12 col-lg-8">
                        ...
                        <div class="col-12 col-lg-6 mt-2">
                                ...
                                <div class="row border border-warning bg-white">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="form-label fw-bold" style="font-size: 20px;">Update Product Description</label>
                                            </div>
                                            <div class="col-12">
                                                <textarea cols="30" rows="15" class="form-control border-warning" id="desc"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row border border-warning bg-white">
                                        ...
                                        <div class="">
                                            <div class="row  offset-0 offset-lg-3">
